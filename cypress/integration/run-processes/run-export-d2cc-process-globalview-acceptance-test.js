...
import {
    ...
    selectGlobalviewForRange,
    timestampStatusForTimestampShouldBe
...
describe('Check CSE D2CC export corner runs correctly', () => {
    ...
    it('Check CSE D2CC export corner runs correctly', () => {
        ...
        gc.authentication()
        selectGlobalviewForRange('2022-01-28T15:30', '2022-01-29T00:30')
        // Automatic run on file arrival
        timestampStatusForTimestampShouldBe('RUNNING', TIMEOUT, Date.parse('2022-01-28T16:30'))
        timestampStatusForTimestampShouldBe('SUCCESS', TIMEOUT, Date.parse('2022-01-28T16:30'))
