...
describe('Check CSE IDCC export corner runs correctly', () => {
    ...
    it('Check CSE IDCC export corner runs correctly', () => {
        ftp.uploadOnFtp('CSE_EXPORT_IDCC', 'run-export/20220128_1630_155_Initial_CSE1_Transit.uct', cgm)
        ftp.uploadOnFtp('CSE_EXPORT_IDCC', 'run-export/20220128_1630_145_CRAC_CO_CSE1_Transit.xml', crac)
        ...
        ftp.deleteOnFtp('CSE_EXPORT_IDCC', 'cgms/20220128_1630_155_Initial_CSE1_Transit.uct')
        ftp.deleteOnFtp('CSE_EXPORT_IDCC', 'cracs/20220128_1630_145_CRAC_CO_CSE1_Transit.xml')
    })
})